        ...
        case 'video':
          {
            ...
            // console.log(item, item.videoRenderer?.avatar.decoratedAvatarViewModel.avatar.avatarViewModel.image.sources[0])

            const author_avatar = item.videoRenderer?.avatar.decoratedAvatarViewModel.avatar.avatarViewModel.image.sources[0].url;
...
function _parseVideoInitialData ( responseText, callback )
{
  ...
  console.log(idata)
  const author_avatar =_jp.value( idata, '$..owner..thumbnail..thumbnails')[0].url;
  console.log(_jp.value( idata, '$..owner..thumbnail..thumbnails')[0].url  )
  const author_url = (
